...
def run_blind_dlib():
    print("="*60)
    print("[EXECUTION] STARTING BLIND TRACK A: DLIB ALIGNED")
    print("="*60)
    ...
    print("[RUNNING] Executing Standard DBSCAN (eps=0.55, min_samples=4)...")
    db_standard = DBSCAN(eps=0.55, min_samples=4)
    ...
    fig.suptitle("Blind Tracking Execution: Dlib Aligned Embeddings Space", fontsize=16, fontweight='bold')
    ...
    out_img = "data/debug/blind_dlib_output.png"
    plt.tight_layout()
    plt.savefig(out_img, dpi=300)
    print(f"[SUCCESS] Isolated Blind Dlib plot saved to: {out_img}\n")
    plt.show()
